...
export default {
  ...
  methods: {
    reload() {
      ...
      axios
        .get(`https://kinda.jdsx.app/api/resources/account-sites/` + this.$route.params.id + `/get`)
    ...
    update() {
      ...
      axios
        .post(`https://kinda.jdsx.app/api/resources/account-sites/`+ this.$route.params.id +`/update`, data)
        .then(response => (this.fields = response.data))
